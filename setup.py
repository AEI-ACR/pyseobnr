...
extensions = [
    ...
    Extension("pyseobnr.eob.utils.containers_coeffs_PN", ["pyseobnr/eob/utils/containers_coeffs_PN.pyx"],
        include_dirs=[np.get_include()],
    ),
    Extension("pyseobnr.eob.utils.utils_pn_opt", ["pyseobnr/eob/utils/utils_pn_opt.pyx"],
        include_dirs=[np.get_include()],
    ),
    Extension("pyseobnr.eob.dynamics.pn_EoMs_opt", ["pyseobnr/eob/dynamics/pn_EoMs_opt.pyx"],
        include_dirs=[np.get_include(),"pyseobnr/eob/utils"],
    ),
