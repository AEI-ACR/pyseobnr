...
cdef class Ham_AvgS2precess_simple_cython_PA_AD(Hamiltonian_v5PHM_C):
    ...
    cpdef Hamiltonian_v5PHM_C_grad_result_t grad(
        ...
        cdef double H = self._call(q,p,chi1_v,chi2_v,m_1,m_2,chi_1,chi_2,chiL1,chiL2)[0]
    ...
    cpdef Hamiltonian_v5PHM_C_dynamics_result_t dynamics(
        ...
        # Evaluate Hamiltonian
        cdef Hamiltonian_v5PHM_C_call_result_t call_ret = self._call(q,p,chi1_v,chi2_v,m_1,m_2,chi_1,chi_2,chiL1,chiL2)
    ...
    cpdef Hamiltonian_v5PHM_C_auxderivs_result_t auxderivs(self, double[:]q,double[:]p,double[:]chi1_v,double[:]chi2_v,double m_1,double m_2,double chi_1,double chi_2,double chiL1,double chiL2):
