...
def perturbation_mismatch_prec(m1,m2, s1x,s1y,s1z,s2x,s2y,s2z, iota_s):
...
def process_one_case(input):
    ...
    m1,m2,  s1x,s1y,s1z,s2x,s2y,s2z, iota_s, mm = perturbation_mismatch_prec(m1,m2, s1x,s1y,s1z,s2x,s2y,s2z, iota_s)
...
if __name__ == "__main__":
    ...
    a1 = np.random.uniform(-a_max, a_max, N)
    np.random.seed(seed+999997)
    a2 = np.random.uniform(-a_max, a_max, N)
